...
include_once('../../connect.php');
  $sql="SELECT * FROM teacher as m 
  INNER JOIN student as p ON p.`class` = m.`class` AND p.`room1` = m.`room1`  GROUP BY `studentID`,`studentName`";
          ...
          <table id="dataTable" class="table table-bordered table-striped w-100 ">
            ...
            <?php while($row=mysqli_fetch_array($res)) { ?>
              <tr>
                ...
                <td>
                  <a href="form-edit2.php?studentID=<?php echo $row['studentID']; ?>" class="btn btn-sm btn-warning text-white">
                    <i class="fas fa-edit"></i> edit
                  </a> 
                  <a href="delete.php?studentID=<?php echo $row['studentID']?>" onClick="return confirm('คุณต้องการลบข้อมูลนี้หรือไม่');" class="btn btn-sm btn-danger">
