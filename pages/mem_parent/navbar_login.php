...
<nav>
		<div class="logo">
      <p style='font-size:20px;'>คุณ <?php echo $_SESSION['user']; ?></p>
		</div>
		<ul>
			<li><a href="../mem_parent/welcome.php">หน้าหลัก</a></li>
			<li><a href="../mem_parent/index_homevisit.php">เยี่ยมบ้าน</a></li>
