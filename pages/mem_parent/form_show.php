...
<?php //เยี่ยมบ้าน
  include_once('../../connect.php');
  $homevisitID=$_GET['homevisitID'];
  $sql1="select * from homevisit where homevisitID = $homevisitID";
...
require_once __DIR__ . '../../homevisit/vendor/autoload.php';
...
?>
            ...
            <div class="row mb-4 pb-2 pb-md-0 mb-md-5">
                ...
                <div class="col-md-6">
                    <a>ละติจูด : </a>
                    <a><?php echo $row1['mlat']?></a>
                </div>
                <div class="col-md-6">
                    <a>ลองติจูด : </a>
                    <a><?php echo $row1['mlog']?></a>
                </div>
            </div>
            <div class="row mb-4 pb-2 pb-md-0 mb-md-5">
                <div class="col-md-12">
            ...
            <div class="row mb-4 pb-2 pb-md-0 mb-md-5">
                ...
                <div class="col-md-6">
                    <a>ความรับผิดชอบ : </a>
                    <a><?php echo $row8['responsibility']?></a>
                </div>
                <div class="col-md-6">
                    <a>ความขยันหมั่นเพียร : </a>
                    <a><?php echo $row8['diligence']?></a>
                </div>
                <div class="col-md-6">
                    <a>ความอดทน : </a>
                    <a><?php echo $row8['patience']?></a>
                </div>
                <div class="col-md-6">
                    <a>ความมีระเบียบวินัย : </a>
                    <a><?php echo $row8['discipline']?></a>
                </div>
                <div class="col-md-6">
                    <a>ความซื่อสัตย์ : </a>
                    <a><?php echo $row8['honesty']?></a>
                </div>
                <div class="col-md-6">
                    <a>ความมีน้ำใจ/เอื้ออาทร : </a>
                    <a><?php echo $row8['kindness']?></a>
                </div>
                <div class="col-md-6">
                    <a>การตรงต่อเวลา : </a>
                    <a><?php echo $row8['punctuality']?></a>
                </div>
                <div class="col-md-6">
                    <a>ความมั่นใจในตนเอง : </a>
                    <a><?php echo $row8['selfconfidence']?></a>
                </div>
                <div class="col-md-6">
                    <a>การใฝ่หาความรู้ : </a>
                    <a><?php echo $row8['pursuingknowledge']?></a>
                </div>
                <div class="col-md-6">
                    <a>การใช้เวลาว่างให้เกิดประโยชน์ : </a>
                    <a><?php echo $row8['freetime']?></a>
                </div>
            </div>
    ...
    ob_end_flush();
?>
        <center><a href="index_homevisit.php" class="btn btn-md btn-info text-black">
