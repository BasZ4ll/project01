...
$search=$_POST['search'];
  $sql="select * from student where studentName like '%".$_POST['search']."%'";
          ...
          <table id="dataTable" class="table table-bordered table-striped w-100 ">
            ...
            <?php while($row=mysqli_fetch_array($res)) { ?>
              <tr>
                ...
                <td>
                  <a href="form_insert.php?studentID=<?php echo $row['studentID']; ?>" class="btn btn-sm btn-success text-white">
                    <i class="fas fa-home"></i> เยี่ยมบ้าน
                  </a>
                  <a href="form_show.php?studentID=<?php echo $row['studentID']; ?>" class="btn btn-sm btn-info text-white">
                    <i class="fas fa-eye"></i> ดู
                  </a>  
                  <a href="index_help.php?studentID=<?php echo $row['studentID']; ?>" class="btn btn-sm btn-warning text-white">
                    <i class="fas fa-bullhorn"></i> ช่วยเหลือ
                  </a>
                </td>
              </tr>
            <?php } ?>
