        ...
        <div class="card-body">
          <table id="dataTable" class="table table-bordered table-striped w-100 ">
            ...
            <tr>
              ...
              <th>ชื่อ</th>
              <th>รายละเอียด</th>
              <th>ผล </th><div class="form-group col-md-12 text-right">   <a href="form_insert_help.php?studentID=<?php echo $row1['studentID']; ?>" class="btn btn-md btn-info text-white">
            ...
            <tbody>
              <tr><?php while($row8=mysqli_fetch_array($res8)) { ?>  
                ...
                <td><?php echo $row8['helpDetail']; ?></td>
